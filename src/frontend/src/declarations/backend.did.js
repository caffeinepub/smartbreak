...
export const CTAType = IDL.Variant({
  'partnerWithUs' : IDL.Null,
  'requestPilotDeployment' : IDL.Null,
});
...
export const idlService = IDL.Service({
  ...
  'createSubmission' : IDL.Func(
      [IDL.Text, IDL.Text, IDL.Text, IDL.Text, CTAType],
      [],
      [],
    ),
